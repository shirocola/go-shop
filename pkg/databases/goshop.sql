...
CREATE TABLE "products_categoriees" (
  "id" varchar PRIMARY KEY,
  "products_id" varchar,
  "categories_id" int
);
...
ALTER TABLE "products_categoriees" ADD FOREIGN KEY ("products_id") REFERENCES "products" ("id");

ALTER TABLE "products_categoriees" ADD FOREIGN KEY ("categories_id") REFERENCES "categories" ("id");
